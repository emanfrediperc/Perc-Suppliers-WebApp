...
@Component({
  ...
  standalone: true,
  imports: [CurrencyPipe, PageHeaderComponent, GlassCardComponent, GlassTableComponent, StatusBadgeComponent, ToastComponent, EmpresaProveedoraFormModalComponent],
  template: `
    <app-toast />
    @if (loading()) {
