...
- Name: session-timer.spec.ts >> Session timer — structural presence >> session timer component is present on facturas route too (layout persists)
- Location: e2e/session-timer.spec.ts:60:7
