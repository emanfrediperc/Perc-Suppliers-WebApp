...
- Name: prestamos.spec.ts >> Prestamos read flows as admin >> filter by currency=USDC then Buscar shows 1 row + 1 summary card
- Location: e2e/prestamos.spec.ts:74:7
