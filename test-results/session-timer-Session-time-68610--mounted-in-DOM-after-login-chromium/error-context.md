...
- Name: session-timer.spec.ts >> Session timer — structural presence >> app-session-timer component is mounted in DOM after login
- Location: e2e/session-timer.spec.ts:29:7
