...
- Name: session-timer.spec.ts >> Session timer — structural presence >> session warning pill is NOT visible immediately after login (timer not yet expired)
- Location: e2e/session-timer.spec.ts:45:7
